        ...
        <Slider {...settings}>
          <div className="uppercase">
            <div className="absolute text-red-500 z-50 w-screen h-screen flex items-center justify-center drop-shadow-2xl">
              <Link to="/street" className="text-shadow-xl text-gray-50 text-5xl">
                Street
              </Link>
            </div>
            <StaticImage
          ...
          <div className="uppercase">
            <div className="absolute text-red-500 z-50 w-screen h-screen flex items-center justify-center drop-shadow-2xl">
              <Link to="/portrait" className="text-shadow-xl text-gray-50 text-5xl">
                Portrait
              </Link>
            </div>
            <StaticImage
          ...
          <div className="uppercase">
            <div className="absolute text-red-500 z-50 w-screen h-screen flex items-center justify-center drop-shadow-2xl">
              <Link to="/nature" className="text-shadow-xl text-gray-50 text-5xl">
                Nature
              </Link>
            </div>
            <StaticImage
